  ...
  return (
    <>
      <div
        ...
        {...listeners}
        className={cn(
          'bg-white rounded-xl shadow-sm p-3 border border-transparent cursor-grab active:cursor-grabbing',
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="flex-1 min-w-0">
            <span className={cn(
              ...
              card.completed ? 'line-through text-slate-400' : 'text-slate-800',
            )}>
              {card.title}
            </span>
            ...
            {/* Description snippet */}
            {card.description && (
              <p className="text-xs text-slate-400 mt-1 line-clamp-2 leading-relaxed break-words">{card.description}</p>
            )}
          </div>
        </div>
          ...
          <div className="mt-2.5 flex items-center gap-2 flex-wrap">
            ...
            {checklistTotal > 0 && (
              <div className="flex items-center gap-1.5 flex-1 min-w-0">
                <svg
                  className={cn('w-3.5 h-3.5 flex-shrink-0', checklistDone ? 'text-emerald-500' : 'text-slate-400')}
                ...
                <div className="flex-1 bg-slate-100 rounded-full h-1">
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: checklistDone ? '#22c55e' : '#3b82f6',
                    }}
                  />
                </div>
                <span className={cn('text-xs font-medium flex-shrink-0', checklistDone ? 'text-emerald-600' : 'text-slate-400')}>
