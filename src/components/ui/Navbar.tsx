...
export default async function Navbar() {
  ...
  return (
    <header className="bg-[var(--color-surface)] border-b border-[var(--color-border)] h-14 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-50 flex-shrink-0">
      ...
      <nav className="flex items-center gap-2 ml-auto">
        {user ? (
          ...
          <>
            ...
            <Link
              href="/register"
              className="bg-[var(--color-brand)] hover:bg-[var(--color-brand-hover)] text-white text-sm font-semibold px-4 py-1.5 rounded-xl transition-all"
            >
              Registro
            </Link>
          </>
