  ...
  return (
    <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-2xl p-6 sm:p-8 animate-fade-in">
      ...
      <div className="space-y-4">
        ...
        {/* Error */}
        {error && (
          <div role="alert" className="bg-red-500/10 border border-red-500/20 text-red-400 text-sm px-4 py-3 rounded-xl flex items-center gap-2">
...
export default function RegisterPage() {
  return (
    <Suspense fallback={<div className="bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl p-8 text-center text-slate-400">Cargando...</div>}>
      <RegisterForm />
    </Suspense>
  )
}