    ...
    <main className="w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-10 bg-[var(--color-bg)]">
      ...
      {workspaces.length === 0 ? (
        <div className="text-center py-24 sm:py-32 animate-fade-in">
          ...
          <p className="text-[var(--color-text-primary)] font-semibold text-base mb-1">Sin workspaces todavía</p>
          <p className="text-[var(--color-text-secondary)] text-sm mb-6">Creá uno para empezar a organizar tus proyectos</p>
          <CreateWorkspaceButton />
        </div>
      ) : (
